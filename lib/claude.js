...
Format each day exactly like this example — meal type and name on one line, then 3–5 ingredient bullets below:
...
Include Monday–Saturday with Breakfast, Lunch, Dinner, and Snack. For Sunday, include Breakfast and Lunch only. After the full meal plan, include a consolidated grocery list organized by category with estimated prices per item and a total estimated cost for the week at ALDI.`,
      },
    ],
  })
