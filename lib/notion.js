...
// Notion rich_text property max is 2000 chars per element — split long text into chunks
...
export async function createMealPlan({ weekStart, plan, groceryList }) {
  return notion.pages.create({
    ...
    properties: {
      ...
      Plan: { rich_text: richTextChunks(plan) },
      'Grocery List': { rich_text: richTextChunks(groceryList) },
    },
  })
}
